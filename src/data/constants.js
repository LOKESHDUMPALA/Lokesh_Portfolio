...
import SriChaitanya from "../images/Srichaitanya.jpeg";
import VignanLogo from "../images/vignanlogo.png";
import Techconnect from "../images/Tech-Connect.png";
import ECommerce from "../images/Ecommerceee.png";
import TeamInfo from "../images/Team-Info.png";
import Quiz from "../images/Quizz.png";


export const Bio = {
    name: "Lokeswara Rao Dumpala",
    roles: [
  ...
  export const experiences = [
    {
      ...
      desc: " Worked on the Design and Development part of a fully responsive webpage for a particular section of ITJOBXS and  Worked on User Verification/Authentication +Engineering challenges of detecting and removing fake bots and posts Integrated Recaptcha with the website - Google Layer of Protection for Websites.",
      skills: [
        "Github",
        "ReactJS",
        "NodeJs",
    ...
    },
    {
      ...
      desc: "Designed and developed responsive web applications using modern framework like React.js for front-end and Node.js for back-end ; Collaborated with cross-functional teams to integrate RESTful APIs ; Utilized MongoDB for efficient data storage and management, ensuring smooth data handling for web applications.",
      skills: [
        "mongoDB",
        "ReactJS",
        "NodeJs",
  ...
  export const projects = [
    {
      ...
      description:
        ` 
  - Developed a web platform for students to access events like hackathons, coding contests, ideathons, and workshops. Addressing the challenge of event discovery for students.
  - Created a user-friendly interface allowing students to authenticate(sign-in, login) and apply for events of interest with ease.
...
`,
  demo: {
    ...
    student: { id: "student@gmail.com", pwd: "student" },
      ...
      github: "https://github.com/LOKESHDUMPALA/TECH-CONNECT",
      webapp: "https://tech-connect-eight.vercel.app/",
    },
    {
      id: 1,
      title: "ECommerce",
      description:
      `
- Developed a fully responsive e-commerce platform with modern UI using ShadCN UI and TailwindCSS. 
- Implemented secure JWT-based authentication with tokens stored in cookies to enhance user security and session management.
- Designed robust product functionalities: Filters, Search, and SortBy options for seamless product discovery.
- Created an Admin Panel enabling admins to add, edit, delete, and manage their products.
...
demo: {
  ...
  user: { id: "user@gmail.com", pwd: "user" },
    ...
    },
    {
      ...
      github: "https://github.com/LOKESHDUMPALA/TEAM_INFO",
      webapp: "https://team-info-gamma.vercel.app/",
    },
    {
      id: 3,
      title: "OpenAI-Quizz",
...
export const codingProfiles = [
  
  {
    ...
    link: "https://leetcode.com/u/lokesh08/",
  },
  {
    name: "Codechef",
    image: "https://www.codechef.com/sites/all/themes/abessive/logo.svg",
    link: "https://www.codechef.com/users/lokesh_88",
  },
  {
    name: "Coding-Ninjas",
    ...
    link: "https://www.naukri.com/code360/profile/lokesh_548",
  },
  {
    name: "GeeksforGeeks",
    image: "https://media.geeksforgeeks.org/wp-content/cdn-uploads/gfg_200X200.png",
    link: "https://www.geeksforgeeks.org/user/lokeswararaodumpala2004/",
  },
...
export const achievements = [
  "Achieved Top 11th Spot in SUSHACKS hackthon out of 150 Teams." ,
  "Achieved 5th prize in Vista 2022 Ideathon at VIIT, a National Level Tech Fest, competing against 100 teams.",
  "Solved 500+ problems ,  2*  coder in Codechef with highest rating 1567 and Leetcode with highest rating 1700.",
];
